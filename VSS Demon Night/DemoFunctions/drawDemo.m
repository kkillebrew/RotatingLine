...
if apNumber == 3   % Elipse
    if gratingNumber == 1 || gratingNumber == 3   % Line
        ...
        if drawDotsToggle ~= 0
            ...
            Screen('FillOval',w,colorArray,[dotX1-5,dotY1-5,dotX1+5,dotY1+5]);
            Screen('FillOval',w,colorArray,[dotX2-5,dotY2-5,dotX2+5,dotY2+5]);
            if drawDotsToggle == 3
                ...
                Screen('FillOval',w,colorArray2,[dotX1-5,dotY1-5,dotX1+5,dotY1+5]);
                Screen('FillOval',w,colorArray2,[dotX2-5,dotY2-5,dotX2+5,dotY2+5]);
            end
        end
